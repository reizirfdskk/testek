...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `oieee @${num.split('@')[0]}\ seja bem vindo/a ao grupo *${mdata.subject}* já vai mamando os adms`
				...
				teks = `espero q esse @${num.split('@')[0]} fdp não volte mais`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
...
case 'lofi':
                ...
                case 'reportarbug':
                    ...
                    client.sendMessage('5521976394573@s.whatsapp.net', options, text, {quoted: mek})
